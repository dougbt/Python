...
imposto_fgts = outro(salario_bruto)
imposto_renda = imposto(salario_bruto)
sindicato  = descontos(salario_bruto)
total_descontos, salario_liquido = total(salario_bruto, imposto_renda, sindicato)
